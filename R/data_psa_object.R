...
#'   \item{other_outcome}{An optional third outcome, \code{NULL} here.}
#'   \item{parameters}{A data frame of input parameters with
#'   \code{n_sim} rows and 15 columns:
#'     \itemize{\item p_S1S2: Annual transition probability of disease progression (S1 to S2)
...
#'              \item c_S2: Annual cost for sicker individuals in S2
...
#'              \item u_S2: Utility for sicker individuals in S2
#'              \item u_D: Utility for dead individuals
#'              \item u_Trt: Utility for treated individuals in S1}
#'   The first three are drawn from the posterior distribution of the calibrated
#'   parameters; the rest are sampled from the distributions that characterize
#'   their uncertainty. The parameters that are not varied in the
#'   probabilistic analysis (\code{n_age_init}, \code{n_t}, \code{d_c} and
#'   \code{d_e}) are not part of this data frame.}
