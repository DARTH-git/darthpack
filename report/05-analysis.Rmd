...
```{r 05a-owsa-nmb, fig.cap = "One-way sensitivity analysis results", echo = FALSE}
...
```{r 05a-twsa-uS1-uTrt-nmb, fig.cap = "Two-way sensitivity results.", echo=FALSE}
...
```{r 05b-ceac-ceaf, fig.cap= "Cost-effectiveness acceptability curves (CEACs) and frontier (CEAF).", echo = FALSE}
knitr::opts_knit$set(root.dir = '..')
