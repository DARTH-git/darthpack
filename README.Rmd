...
```
11. In RStudio, load all the functions from the repository by typing `devtools::load_all(".")`
...
devtools::install_github("DARTH-git/dampack")
```
5. In RStudio, load all the functions from the repository by typing `devtools::load_all(".")`
